...
import { RoleFormType } from '@/components/forms/roleForm/RoleForm';
...
export const createRole = async (body: RoleFormType) => {
  try {
...
export const editRole = async (body: { id: string } & RoleFormType) => {
  try {
