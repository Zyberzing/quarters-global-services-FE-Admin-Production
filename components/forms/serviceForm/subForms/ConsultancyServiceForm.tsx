...
const formSchema = z.object({
  ...
  consultancyType: commonFieldSchema(),
  appointmentMode: commonFieldSchema(),
...
const ConsultancyServiceForm = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      consultancyType: defaultData?.serviceFields?.consultancyType || '',
      appointmentMode: defaultData?.serviceFields?.appointmentMode || '',
