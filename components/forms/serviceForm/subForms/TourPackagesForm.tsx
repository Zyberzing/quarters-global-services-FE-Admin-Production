...
const formSchema = z.object({
  ...
  destination: commonFieldSchema(),
  departureDate: commonFieldSchema(),
  returnDate: commonFieldSchema(),
  numberOfTravelers: commonFieldSchema(),
  budgetRange: commonFieldSchema(),
  travelTheme: commonFieldSchema(),
...
const TourPackagesForm = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      destination: defaultData?.serviceFields?.destination || '',
      departureDate: defaultData?.serviceFields?.departureDate || '',
      returnDate: defaultData?.serviceFields?.returnDate || '',
      numberOfTravelers: defaultData?.serviceFields?.numberOfTravelers || '',
      budgetRange: defaultData?.serviceFields?.budgetRange || '',
      travelTheme: defaultData?.serviceFields?.travelTheme || '',
