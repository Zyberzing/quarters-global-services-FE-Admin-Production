...
const formSchema = z.object({
  ...
  eventType: commonFieldSchema(),
  eventDate: commonFieldSchema(),
  organizerAddress: commonFieldSchema(),
...
const ConcertWeddingPrivateTourForm = ({
  isView,
  platformServiceId,
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      eventType: defaultData?.serviceFields?.eventType || '',
      eventDate: defaultData?.serviceFields?.eventDate || '',
      organizerAddress: defaultData?.serviceFields?.organizerAddress || '',
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="time" {...field} disabled={isView} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
